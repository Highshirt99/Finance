...
const RecurringBills = () => {
  ...
  <div className="flex p-4 flex-col space-y-3">
      ...
      <span className="text-[#434247] text-[11px] font-bold">$200.00</span>
      </div>
      ...
      <span className="text-[#434247] text-[11px]  font-bold">$100.00</span>
      </div>
      ...
      <span className="text-[#434247] text-[11px]  font-bold">$50.00</span>
      </div>
  </div>
  </div>
  )
